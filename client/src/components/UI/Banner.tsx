...
const Banner = () => {
  return (
    <header className="relative w-full overflow-hidden rounded-b-3xl shadow-2xl border-b border-slate-800/80">
      ...
      <div className="h-72 md:h-96 lg:h-128 relative w-full overflow-hidden">
        <img
        ...
        <div className="absolute inset-0 bg-linear-to-t from-[#0B1120] via-[#0B1120]/60 to-transparent" />
        <div className="absolute inset-0 bg-linear-to-r from-[#0B1120]/80 via-transparent to-[#0B1120]/80" />
      </div>
